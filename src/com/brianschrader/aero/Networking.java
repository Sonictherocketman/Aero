...
public class Networking {
	...
	/**
     * Returns a Java Object of the type specified that contains the values from the corresponding JSON response.
     * UNTESTED
	 * @author Brian Schrader
	 * @param url
	 * @param aClass
    ...
    /**
     * Pass it a JSON object and a Class name, it gives you an object of that class all nicely filled out
     * with the data from the JSON.
     * UNTESTED!
	 * @author Brian Schrader
     * @param json
     * @param aClass
